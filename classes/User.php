...
class User{
    public function buyTicket() {
        ...
        if(UserValidation::numberOfHoursValidation($numberOfHours) && 
           UserValidation::startHourValidation($day, $startHour)) {
            ...
            if(UserValidation::ticketDateValidation($day, $startDate, $finishDate)) {
    ...
    public function bookLesson() {
        ...
        if(UserValidation::lessonHoursValidation($numberOfHours) && UserValidation::lessonTypeValidation($type) && 
           UserValidation::instructorValidation($instructorLogin, $type, $day) && 
           UserValidation::lessonParticipantsValidation($numberOfParticipants)) {
            ...
            if(UserValidation::isLessonBeetwenInstructorTimetable($startDate, $finishDate, $instructorLogin) && 
               UserValidation::isLessonDatetimeAvailable($startDate, $finishDate, $instructorLogin) && 
               UserValidation::isLessonDatetimeFuture($startDate)) {
                    $this->insertNewLesson($instructorLogin, $startDate, $finishDate, $numberOfHours, 
                                           $numberOfParticipants, $type);
            }
        }
        header("Location: userPage.php");
    }
