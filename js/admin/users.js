...
function displayUserInfo(data) {
    if(data.login === null) $("#userInfo").html('<h4 class="text-danger py-2">Nie ma takiego użytkownika!</h4>');
        ...
        let HTML = '<div class="col-sm-6 py-2">Imię: <b>'+data.firstname+'</b></div>'+
                   ...
                   '<div class="col-sm-6 py-2">Liczba zakupionych karnetów: <b>'+data.ticket.uncancelled+'</b></div>'+
                   '<div class="col-sm-6 py-2">Liczba anulowanych karnetów: <b>'+data.ticket.cancelled+'</b></div>'+
                   '<div class="col-sm-6 py-2">Liczba zarezerwowanych lekcji: <b>'+data.lesson.uncancelled+'</b></div>'+
                   '<div class="col-sm-6 py-2">Liczba anulowanych lekcji: <b>'+data.lesson.cancelled+'</b></div>'+
                   '<div class="col-sm-6 py-2">Liczba wypożyczeń: <b>'+data.hire+'</b></div>'+
                   '<div class="col-sm-6 py-2">Liczba serwisów: <b>'+data.service+'</b></div>'+
